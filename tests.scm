...
(begin (atom? 'hiworld) (boolean? (odd? 6)))
; expect True
...
; expect (lambda (first second) (cons first second))

(lambda () (* 3 6))
; expect (lambda () (* 3 6))

(lambda (word) ('word))
; expect (lambda (word) ((quote word)))

(lambda (number) (+ 45 number) (- number 7) (* number 3))
; expect (lambda (number) (+ 45 number) (- number 7) (* number 3))
...
(define (cube r w) (* r r r))
; expect cube

cube
; expect (lambda (r w) (* r r r))
...
((lambda (a b c) (+ a b c)) 1 2 3 4)
; expect Error

((lambda (a b c d) (+ a b c d)) 1 2 3)
; expect Error
...
(lambda (a b c) (/ 1 0))
; expect (lambda (a b c) (/ 1 0))

;;; q12
(define e (lambda (f) (lambda (g) (* f g))))
; expect e

e
; expect (lambda (f) (lambda (g) (* f g)))
...
;;; q17
(define h (mu (num) (/ num 2)))
; expect h

(define v (lambda (b n) (h (* b n) (/ b n))))
; expect v
